...
const { getSecretariat } = require('../config/routing');

/**
 * Transmet un email au secrétariat quand le bot ne peut pas répondre au client.
 *
...
async function forwardEmail(email, classification) {
    const { label, urgent } = classification;
    const dest = getSecretariat();
